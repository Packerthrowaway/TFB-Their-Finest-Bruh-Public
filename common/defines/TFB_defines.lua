...
NDefines.NProduction.MIN_LAND_EQUIPMENT_CONVERSION_RESOURCE_COST_FACTOR = 0.20		-- Minimum fraction of a land equipment's strategic resource cost that any conversion will cost.

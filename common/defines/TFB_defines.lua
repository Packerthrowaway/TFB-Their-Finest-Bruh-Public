...
##NMilitary
	...
	NDefines.NMilitary.PARACHUTE_PENALTY_RANDOMNESS = 0.05,			   -- Random factor for str,manpower,eq penalties.
	NDefines.NMilitary.PARACHUTE_DISRUPTED_AA_PENALTY = 0.8,            -- How much the Air defence in the state (from AA buildings level * air_defence) is scaled to affect overall disruption (equipment,manpower,str).
	...
	NDefines.NMilitary.COMBAT_OVER_WIDTH_PENALTY = -2,					-- over combat width penalty per %.
